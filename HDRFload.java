...
public class HDRFload {
	...
	public HDRFload(int pNum, float balance, int vNum, String edgePath, String data,int ipercent,String inputOrder) throws IOException {
		...
		if (ipercent!=100) {
			File file=new File("D:\\dataset\\hdrf\\" + data
		...
		for (int i = 0; i < pNum; i++) {
			if (ipercent!=100) {
				...
				out[i] = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("D:\\dataset\\hdrf\\" + data
	...
	public void output() throws IOException {
		...
		/*BufferedWriter out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("D:\\dataset\\hdrf\\dblp-16-belong.txt")));
		for (Vertex vertex : vertexList) {
	...
	public static void main(String[] args) throws IOException {
		...
		for (String data : datas) {
			...
			for (int pNum : ps) {
				...
				HDRFload greedy = new HDRFload(pNum, balance, vNum, edgePath, data, ipercent, inputOrder);
